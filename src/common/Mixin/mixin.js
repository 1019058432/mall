...
import BackTop from "components/common/scroll/ScrollTop";
      ...
      switch (index) {
        case 0:
          ...
          if (this.currentType != POP && this.isTabFixed) {
            this.$refs.scroll && this.$refs.scroll.scrollTop(0, (-this.tabOffsetTop), 0);
          }
...
export const itemListenerMixin = {
  ...
  mounted() {
    this.newRefresh = debunce(this.$refs.scroll.refresh, 200)
